...
module.exports = { // everything will be exported
  validateBody: (schema) => { //one function - takes a schema as arg
    return (req, res, next) => { //check the data
  ...
  schemas: { // an obj that will contain all the needed schemas in this proj
      authSchema: Joi.object().keys({ // here all the props to be validated
